...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String BASE_URL = "https://androidappk.000webhostapp.com";
    private static final String FULL_URL = BASE_URL+"/spacecraft/";
    class Spacecraft {
        @SerializedName("id")
        private int id;
        @SerializedName("name")
    ...
    class ListViewAdapter extends BaseAdapter{
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            TextView txtDestination = view.findViewById(R.id.destinationTextView);
            ...
            txtDestination.setText(thisSpacecraft.getDestination());
